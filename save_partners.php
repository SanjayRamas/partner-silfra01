...
//corporate_implementation_partner
$stmt2 = $DBcon->prepare("INSERT INTO corporate_implementation_partner (corporate_legal_name,csr_director_name,	csr_director_mobile,number_csr_locations,number_shareable_csr_locations,spectfic_instruction_to_HHH,location_csr_rep_name,location_csr_rep_email,csr_budgets_available_this_FY_for_trainer_salaries,other_temp_staff_to_help_HHH_student_mobilization,	template_for_data_collection_from_MIC,csr_director_email) VALUES('$corporate_legal_name','$csr_director_name','$csr_director_mobile','$number_csr_locations','$number_shareable_csr_locations','$spectfic_instruction_to_HHH','$location_csr_rep_name','$location_csr_rep_email','$csr_budgets_available_this_FY_for_trainer_salaries','$other_temp_staff_to_help_HHH_student_mobilization','$template_for_data_collection_from_MIC','$csr_director_email')");
$stmt2->execute();
